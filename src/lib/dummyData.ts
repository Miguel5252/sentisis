export const productsData = [
  ...
  },
  {
    ...
    description:
      'Curabitur eget magna dui. Nam risus ligula, sagittis eget malesuada eu, blandit eget urna. Sed dignissim ante id quam feugiat, eget dictum libero sollicitudin. Aliquam a urna nec leo efficitur facilisis.',
    price: 8.5,
    currency: 'euro',
  },
  {
  ...
  },
  {
    ...
    description:
      'In mollis ipsum quis interdum bibendum. Sed sed quam vehicula nunc interdum vestibulum vel quis quam. Nulla sed sagittis odio. Etiam ultricies venenatis elit, quis rhoncus magna commodo nec. Aliquam.',
    price: 35,
    currency: 'euro',
  },
  {
